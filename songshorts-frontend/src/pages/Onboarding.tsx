...
export default function Onboarding({ session, onComplete }: OnboardingProps) {
  ...
  return (
    ...
    >
      {/* Ambient orbs */}
      <div className="absolute top-[-15%] left-1/2 -translate-x-1/2 w-[120%] h-[50vh] rounded-full blur-[120px] bg-[#D946EF]/6 pointer-events-none" />
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <button
                    ...
                    style={
                      selectedGenres.includes(g)
                        ? { background: '#D946EF', color: '#0a0a0f', boxShadow: '0 0 12px rgba(217,70,239,0.3)' }
            ...
            <button
              ...
              style={{ background: '#D946EF', color: '#0a0a0f', boxShadow: '0 4px 20px rgba(217,70,239,0.25)' }}
            >
