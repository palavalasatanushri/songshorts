...
const BRAND_GRAD = 'linear-gradient(135deg, #FDF4FF 0%, #FDF4FF 50%, #FDF4FF 100%)';
  ...
  return (
    <div className="inner-scroll h-full overflow-y-auto px-4 pt-5 pb-6 flex flex-col gap-6">
      ...
      <section className="flex flex-col gap-4 max-w-3xl mx-auto w-full pb-20">
        ...
        <div className="group relative flex items-center justify-between p-4 sm:p-6 bg-[#1A1625] rounded-3xl hover:bg-[#252031] transition-all duration-500 shadow-xl overflow-hidden border border-white/5 hover:border-[#D946EF]/40 text-left w-full">
          <input 
            type="file" 
            accept="audio/*" 
          ...
          />
          <div className="absolute -left-10 -bottom-10 w-32 h-32 rounded-full blur-3xl opacity-10 group-hover:opacity-20 transition-opacity duration-500 bg-[#D946EF]" />
          ...
          <div className="relative z-10 flex items-center gap-4 sm:gap-6 flex-1 min-w-0">
            <div className="p-3 sm:p-4 rounded-2xl bg-[#110D17] border border-white/5 flex-shrink-0 flex items-center justify-center">
              <span className="material-symbols-outlined text-[32px] sm:text-[40px] text-[#D946EF]" style={{ fontVariationSettings: "'FILL' 1" }}>
                upload_file
              </span>
            </div>
            <div className="flex-1 min-w-0 pr-4">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-1 group-hover:text-[#D946EF] transition-colors duration-300 truncate">
          ...
          <div className="relative z-10 flex-shrink-0">
            <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider text-black bg-[#D946EF] hover:bg-white active:scale-95 transition-all shadow-lg">
              Upload
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1A1625] border border-white/10 p-6 rounded-3xl w-full max-w-md shadow-2xl flex flex-col gap-4">
            <h3 className="text-2xl font-black text-white flex items-center gap-2">
              <span className="material-symbols-outlined text-[#D946EF]">smart_toy</span> 
              Insta Extractor
            </h3>
            ...
            <input 
              ...
              className="w-full bg-[#110D17] border border-[#D946EF]/30 rounded-xl p-3 text-white placeholder-white/30 focus:outline-none focus:border-[#D946EF] transition-colors"
            />
            <input 
            ...
            <div className="flex gap-3 mt-2">
              ...
              <button onClick={handleImport} disabled={isImporting} className="flex-1 py-3 rounded-xl bg-[#FDF4FF] text-black font-bold hover:bg-[#e6e0d4]">
