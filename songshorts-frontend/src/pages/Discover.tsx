  ...
  if (queue.length === 0) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center gap-4 text-white/50 p-8 text-center" style={{ background: '#0a0a0f' }}>
        <span className="material-symbols-outlined text-5xl text-[#D946EF]">music_off</span>
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-2 pointer-events-auto">
                ...
                {isCurrent && (
                  <div className="flex items-center gap-3 mt-1">
                    <button
                      ...
                      style={{ background: '#D946EF', boxShadow: '0 4px 20px rgba(217,70,239,0.35)' }}
                    >
                ...
                {!isCurrent && (
                  <button
                    ...
                    style={{ background: '#D946EF', boxShadow: '0 2px 12px rgba(217,70,239,0.3)' }}
                  >
              ...
              <div className="flex flex-col items-center gap-4 pb-1 flex-shrink-0 pointer-events-auto">
                ...
                <div className="flex flex-col items-center gap-0.5">
                  <button
                    ...
                    style={{
                      background: isLiked ? '#D946EF' : 'rgba(255,255,255,0.1)',
                      backdropFilter: 'blur(12px)',
                      border: '1px solid rgba(255,255,255,0.12)',
                      boxShadow: isLiked ? '0 0 16px rgba(217,70,239,0.4)' : 'none',
                    }}
                  >
                    <span
                ...
                <div className="flex flex-col items-center gap-0.5">
                  <button
                    onClick={() => window.dispatchEvent(new CustomEvent('songshorts:add-to-playlist', { detail: track }))}
                ...
                <div className="flex flex-col items-center gap-0.5">
                  <button
                    onClick={() => navigator.share?.({ title: track.title, text: `Listen to ${track.title} by ${track.artist} on SongShorts` })}
                    className="w-11 h-11 rounded-full flex items-center justify-center active:scale-90 transition-transform"
                    style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.12)' }}
                  >
